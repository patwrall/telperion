...
Strength work is essential for injury prevention, power development, and
late-race durability. Include 1-2 sessions per week.
...
For endurance events, 80% of volume should be easy (Zone 1-2), 20% hard (Zone
4+). Avoid excessive Zone 3 "gray zone" training.
