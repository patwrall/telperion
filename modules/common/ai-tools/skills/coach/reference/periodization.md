...
2. **No same sport back-to-back** - Spread swim/bike/run across the week (no
   swim Mon + swim Tue)
3. **Respect long session recovery** - Easy day after long rides/runs
4. **Consistent weekly structure** - Same sports on same days each week helps
   athletes plan
5. **Include doubles strategically** - AM/PM splits for time efficiency or brick
   practice
...
**The 10% Rule**: Increase weekly volume by no more than 10% per week—**for
athletes building new fitness**.
...
**Example**: An Ironman finisher who took 3 months off can progress faster than
a beginner. Their muscles, tendons, and cardiovascular system have adapted
before. Where a beginner might take 20 weeks to reach 10-hour training weeks,
someone rebuilding might get there in 10-12 weeks.

**However**: Always validate with the athlete. Time off due to injury requires
more caution than time off due to life circumstances.
...
Never increase the long session by more than 2-3km (running) or 15-20km
(cycling) per week.
...
**Minimum training time**: 12-15 hours/week at peak **Minimum build time**:
24-30 weeks from solid base
...
**Minimum training time**: 8-12 hours/week at peak **Minimum build time**: 16-20
weeks from solid base
...
**Minimum training time**: 6-10 hours/week at peak **Minimum build time**: 16-20
weeks
...
**Implication**: Base phases should be longer than athletes want. Intensity
phases should be shorter. The deepest adaptations take months—there are no
shortcuts.
