...
**Gut training is essential.** Practice race nutrition in training—start with
30g/hr and build up over 4-6 weeks.
...
**Caution:** Practice caffeine timing in training. Some athletes get GI
distress.
...
- **Limited pool access**: Substitute open water, dryland swim exercises, or
  band work
- **Time-crunched**: Prioritize key sessions, use high-intensity low-duration
  alternatives
