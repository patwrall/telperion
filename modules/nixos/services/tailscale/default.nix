...
let
  ...
  cfg = config.telperion.services.tailscale;
in
{
  options.telperion.services.tailscale = with types; {
    ...
    assertions = [
      {
        ...
        message = "telperion.services.tailscale.autoconnect.key must be set";
      }
    ];
