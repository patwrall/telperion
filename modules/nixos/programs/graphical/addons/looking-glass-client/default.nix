...
let
  inherit (lib) mkIf;
  inherit (config.telperion) user;

  cfg = config.telperion.programs.graphical.addons.looking-glass-client;
in
{
  options.telperion.programs.graphical.addons.looking-glass-client = {
